// // clientSide/src/components/TraineeForm.jsx
...
//       <h2 className="text-2xl font-bold mb-4">التسجيل كمتدرب</h2>
...
const TraineeForm = () => {
  ...
  return (
    <div
      className="bg-gradient-to-br from-teal-50 to-cyan-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8 font-sans"
      dir="rtl"
    >
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-teal-600 to-cyan-600 py-6">
          ...
          <p className="text-teal-100 text-center mt-2">
            انضم إلى برامجنا التدريبية وطوّر مهاراتك
          </p>
        </div>
                    ...
                    <input
                      ...
                      className={`block w-full p-3 border ${
                        formErrors.fullName
                          ...
                          : "border-gray-300"
                      } rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition`}
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="3"
                      className="block w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition"
            ...
            <div className="flex justify-between mt-8">
              {currentStep > 1 && (
                <button
                  type="button"
                  onClick={prevStep}
                  className="py-2 px-4 border border-teal-300 rounded-lg shadow-sm text-md font-medium text-teal-700 bg-white hover:bg-teal-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition"
                >
                  السابق
                </button>
              )}
              {currentStep < totalSteps ? (
                <button
                  type="button"
                  onClick={nextStep}
                  className="py-2 px-6 border border-transparent rounded-lg shadow-sm text-md font-medium text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition"
                >
                  التالي
                </button>
              ) : (
                <button
                  type="submit"
                  disabled={loading}
                  className={`py-3 px-8 border border-transparent rounded-lg shadow-sm text-md font-medium text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition ${
